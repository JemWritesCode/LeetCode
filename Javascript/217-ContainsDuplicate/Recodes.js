// #region 53 -- August 27, 2026
/**
 * @param {number[]} nums
 * @return {boolean}
 */

// Time Complexity: O(n) - where n is the number of elements in the nums array. In the worst case there are no duplicates and we search through the entire array looking for one.
// Space Complexity: O(n) - where n is the number of elements in the nums array. In the worst case there are no duplicates and the set becomes a copy of the nums array.
...
// Space Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario there are no duplicates and set becomes a copy of the nums array.
var containsDuplicate = function (nums) {
  let set = new Set();
  for (let num of nums) {
    if (set.has(num)) return true;
...
// #region 49 -- April 4, 2026
/**
 * @param {number[]} nums
 * @return {boolean}
 */
// Time Complexity: O(n) where n is the number of elments in the nums array. In the worst case there are no duplicates and we visit every elment of the array looking for one.
// Space Complexity: O(n) where n is the number of elements in the nums array. In the worst case there are no duplicates and set becomes a copy of the nums array.
var containsDuplicate = function (nums) {
  let set = new Set();
  for (let num of nums) {
    if (set.has(num)) return true;
...
// Time Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario we must visit each element of the nums array to see if there are any duplicates and there are none.
// Space Complexity: O(n) where n is the number of elements in the nums array. In the worst case there are no duplciates and set becomes a copy of the nums array.
var containsDuplicate = function (nums) {
  let set = new Set();
  for (let num of nums) {
    if (set.has(num)) return true;
...
// Space Complexity: O(n) where n is the nubmer of elements in the nums array. In the worst case scenario there are no duplicates and we copy every element of the nums array into the set.
...
// Space Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario there is no duplicate and we copy every element of the nums array into the set.
var containsDuplicate = function (nums) {
  let set = new Set();
  for (let num of nums) {
    if (set.has(num)) return true;
...
// #region 41 -- July 31 2025
/**
 * @param {number[]} nums
 * @return {boolean}
 */

//Time Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario we have no duplicates and we traverse the entire array looking for one.
// Space Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario we have no duplicates and we copy every element of the nums array into the set.
var containsDuplicate = function (nums) {
  let set = new Set();
  for (let num of nums) {
    if (set.has(num)) return true;
...
// #region 40 -- July 18 2025
/**
 * @param {number[]} nums
 * @return {boolean}
 */

// Time Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario there are no duplicates in the array and we traverse the entire nums array looking for one.
// Space Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario there are no duplicates and we copy every element of the nums array into the set.
var containsDuplicate = function (nums) {
  const set = new Set();
  for (let num of nums) {
    if (set.has(num)) return true;
 ...
 */
// Time Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario there are no duplicates and we traverse the entire nums array looking for one.
// Space Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario there are no duplciates and we copy every element of the nums array into the map.
var containsDuplicate = function (nums) {
  const set = new Set();
  for (let num of nums) {
    if (set.has(num)) return true;
...
// #region 37 -- June 6 2025
/**
 * @param {number[]} nums
 * @return {boolean}
 */
// Time Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario we have no duplicates so we traverse the entire array looking for one.
// Space Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario we have no duplicate so we copy every element of the nums array into the set.
var containsDuplicate = function (nums) {
  const set = new Set();
  for (num of nums) {
    if (set.has(num)) return true;
...
// #region 36 -- June 1 2025
/**
 * @param {number[]} nums
 * @return {boolean}
 */

// Time Complexity: O(n) where n is the number of characters in the nums array. In the worst case scenario there are no duplicates and we traverse the entire array looking for one.
// Space Complexity: O(n) where n is the number of characters in the nums array. In the worst case scenario there are no duplciates and we end up copying every element of the nums array into the seen set.
var containsDuplicate = function (nums) {
  const seen = new Set();
  for (let num of nums) {
    if (seen.has(num)) return true;
...
// #region 35 -- May 11 2025
/**
 * @param {number[]} nums
 * @return {boolean}
 */

// Time Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario there is no duplicate and we search the entire array looking for one.
// Space Complexity: O(n) where n is the number of elements in the nums array. In the worst case scenario there is no duplicate and we add every element of nums to the seen set as we look for one.
var containsDuplicate = function (nums) {
  const seen = new Set();
  for (let num of nums) {
    if (seen.has(num)) return true;
