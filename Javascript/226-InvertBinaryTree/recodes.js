 ...
 * @return {TreeNode}
 */
// Time Complexity: O(n) where n is the number of nodes in the tree. We must visit each node to invert it.
//Space Complexity: O(h)
var invertTree = function (root) {
  if (!root) return null; // The cake and the tree are a lie
