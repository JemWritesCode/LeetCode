...
// Space Complexity: O(1) we only need the 3 pointer variables, we traverse the list in place.
...
// Time Complexity: O(n) where n is the number of nodes in the linked list. We must traverse through the entire linked list to reverse every link.

// Space Complexity: O(1) we just need 3 pointer variables. We reverse the linked list in place. A
var reverseList = function (head) {
  let prev = null,
    curr = head;
  while (curr) {
...
// Asymptotic Notation
// Time Complexity: O(n) where n is the number of nodes in the linked list. We must visit each node in the linked list to reverse the link.
// Space Complexity: O(1) We only need the curr, prev, and next variables. We reverse the linked list in place.
var reverseList = function (head) {
  let curr = head,
    prev = null;
  while (curr) {
...
// Time Complexity: O(n) We must visit each node of the linked list to reverse the link of the node.
// Space Complexity: O(1) We only need the curr, prev, and next variables. We reverse the linked list in place.
var reverseList = function (head) {
  let curr = head,
    prev = null;
